...
<body>
	...
	<header class="header-area">
		...
		<div class="phone-number">+62 81234567890</div>
		{{-- <nav class="nav-menu">
			<ul>
	...
	<section class="hero-section">
		...
		<div class="hero-slider">
			<div class="hero-slide-item set-bg" data-setbg="img/bg.jpg">
				<div class="slide-inner">
					...
					<h2>Clean <br>Fast <br> and more</h2>
					<a href="#" class="site-btn sb-light">See Results</a>
					</div>	
				</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/bg.jpg">
		...
		<div class="hero-right-text">ultimate car wash</div> 
	</section>
	<!-- Hero section end -->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 intro-text mb-5 mb-lg-0">
					<h2 class="sp-title">We are a Professional<span>Car Wash</span></h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 pl-lg-0 offset-lg-5 cta-content">
					<h2 class="sp-title">Dare to clean your <span>whip</span></h2>
	...
	<div class="projects-section pb50">
		<div class="container">
			<div class="row">
				<div class="col-lg-3">
					<div class="section-title">
						<h1>Best Car Projects</h1>
					</div>
				</div>
				<div class="col-lg-9">
					<ul class="projects-filter-nav">
						<li class="btn-filter" data-filter="*">All</li>
						<li class="btn-filter" data-filter=".rest">Cleaning</li>
						<li class="btn-filter" data-filter=".build">Waxing</li>
						<li class="btn-filter" data-filter=".apart">Coating</li>
					</ul>
				</div>
			</div>
		</div>                      
		<div id="projects-carousel" class="projects-slider">
			...
			<div class="single-project set-bg rest" data-setbg="img/projects/4.jpg">
				<div class="project-content">
					<h2>Lamborghini <br> Sesto Elemento</h2>
					<p>Jan 19, 2018</p>
					<a href="#" class="seemore">See Project </a>
				</div>
			</div>
